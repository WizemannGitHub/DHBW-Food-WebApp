...
// 12 KW-Zellen; w1 = KW 20 (12.05.) … w12 = KW 31 (27.07.)
#let task-cells(sw, ew, crit: false) = range(1, 13).map(w => {
...
#align(center)[
  ...
  #v(0.05cm)
  #text(size: 10pt)[DHBW Food Web App · Gantt-Diagramm · KW 20–31 (12.05.–03.08.2026)]
  #v(0.15cm)
  #line(length: 100%)
]
...
#table(
  columns: (0.55cm, 3.2cm, 2.0cm, 1.1cm,
            1.66cm, 1.66cm, 1.66cm, 1.66cm, 1.66cm, 1.66cm,
            1.66cm, 1.66cm, 1.66cm, 1.66cm, 1.66cm, 1.66cm),
  rows: auto,
  ...
  [1.2], [Projektsteuerung], [12.05.–03.08.], [1.1],  ..task-cells(1, 12),
  [1.3], [Projektabschluss], [27.07.–03.08.], [5.3],  ..task-cells(12, 12, crit: true),
  ...
  // ─── Meilensteine ──────────────────────────────────────────────────────────
  // w1:M0  w2:–  w3:M1  w4:M2  w5:–  w6:–  w7:M3  w8:–  w9:M4  w10:M5  w11:–  w12:M6/M7
